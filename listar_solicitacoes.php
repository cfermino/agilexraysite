                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <thead>
                      ...
                      <tbody>
                      <?php
                                $stmt = $conn->query("SELECT a.id,tx_empresa,a.tx_nome,a.tx_cargo,b.tx_plano_pt,date_format(a.dt_cadastro,'%d/%m/%Y') as datacadastro FROM agile_perfil a left join agile_planos b on a.id_plano = b.id");
                        ...
                        <tr>
                          ...
                          <td><?php echo utf8_encode($perfil->tx_nome);?>
                           
                          </td>
                          <td><?php echo utf8_encode($perfil->tx_plano);?>
                          </td>
                          <td>
