...
$sqlMedia = 'select c.tx_eixo_pt,b.in_nota,a.in_peso from agile_notas_respondentes b inner join agile_perguntas a  on b.id_pergunta = a.id inner join agile_eixos c on a.id_eixo = c.id where b.id_respondente = "'.$id_respondente.'" and  b.id_diagnostico = "'.$id_diagnostico.'"';
$notaFinal = 0;
$perguntas = 0;
...
?>
   ...
   <div class="container">
    ...
    <div class="section">
	 ...
	 if((!isset($_SESSION['login']) or $_SESSION['login'] == '0') or ($_SESSION['login'] <> $_GET['id_perfil']) or ($_SESSION['id_diagnostico'] <> $_GET['id_diagnostico']) ) { ?>

 <form id="registerForm" name="registerForm" action="http://agilexray.agenciajudito.com/login_respondente_visualizar.php" method="post">
...
foreach($mediasEixos as $key => $value){
                      ?>                   
					<?php echo round($value,1);if($i < sizeof($mediasEixos)){echo ',';}
                  $i++;
                   } ?>]}]
									};
