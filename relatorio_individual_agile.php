...
$stmtData = $conn->query('select c.tx_eixo_pt,b.in_nota,a.in_peso,date_format(b.dt_cadastro,"%d/%m/%Y") as dt_resposta from agile_notas_respondentes b inner join agile_perguntas a  on b.id_pergunta = a.id inner join agile_eixos c on a.id_eixo = c.id where b.id_respondente = "'.$id_respondente.'" and  b.id_diagnostico = "'.$id_diagnostico.'"');
$resRespondenteData = $stmtData->fetch();

$sqlMedia = 'select c.tx_eixo_pt,b.in_nota,a.in_peso,date_format(b.dt_cadastro,"%d/%m/%Y") as dt_resposta from agile_notas_respondentes b inner join agile_perguntas a  on b.id_pergunta = a.id inner join agile_eixos c on a.id_eixo = c.id where b.id_respondente = "'.$id_respondente.'" and  b.id_diagnostico = "'.$id_diagnostico.'"';
$notaFinal = 0;
$perguntas = 0;
   ...
   <div class="container">
    ...
    <div class="section">
                ...
                <div class=" col s12">
                    ...
                    <p><b>Respondeu em: </b><?php echo utf8_encode($resRespondenteData['dt_resposta']); ?>  </p>
                </div>
            </div>
            <div class="row">
                <div class=" col s12">
            ...
            <div class="row">
                <div class=" col s12">
                   <a href="http://agilexray.agenciajudito.com/relatorio_geral.php?id_diagnostico=<?php echo trim($_GET['id_diagnostico']);?>">Voltar para Relatório Geral</a>
                </div>
            </div>            
            ...
            <div class="row">
                <div class="col s6">
                    <div class="row" style="margin-bottom:0px !important">
                        ...
                        <div class=" col s3" style="background-color:<?php echo corMaturidade($mediaFinal);?>;color:#fff;padding:10px;text-align:center;text-transform:uppercase;font-weight:bold;font-size:14px">
                            <?php echo maturidade($mediaFinal);?>
                        </div>
                        <div class=" col s3" style="background-color:#000;color:#fff;padding:10px;text-align:center;text-transform:uppercase;font-weight:bold;font-size:14px">
                            <b><?php echo number_format($mediaFinal,2); ?></b>
                        </div>              
                    </div>
                </div>
            ...
            <div class="row">
                <div class=" col s6">
                    <div class="row">
                        <div class="col s12">
                            <h5>Principais pontos de melhoria  </h5>
                        </div>
                    </div>
                    <?php 
...
foreach($mediasEixos as $key => $value){
                      ?>                   
					<?php echo number_format($value,1);if($i < sizeof($mediasEixos)){echo ',';}
                  $i++;
                   } ?>]}]
									};
									options = {
