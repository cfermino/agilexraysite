              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php
                                $stmt = $conn->query("SELECT * FROM agile_diagnosticos where id='".$_GET['id']."'");
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="corpo_email_pt" name="corpo_email_pt" rows="8" class="form-control col-md-7 col-xs-12" style=""><?php echo utf8_encode($diagnostico->corpo_email_pt);?> </textarea>
                            </div>
                        </div>      
                        <div class="form-group">
                            ...
                            <textarea id="corpo_email_en" name="corpo_email_en" rows="8" class="form-control col-md-7 col-xs-12" style=""><?php echo utf8_encode($diagnostico->corpo_email_en);?></textarea>
                            </div>
                        </div> 
